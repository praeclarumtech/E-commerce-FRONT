...
interface DeleteStateModelProps {
    isOpen: boolean;
    onClose: () => void;
    onConfirm: () => void;
    isDeleting: boolean;
...
function DeleteStateModel({ isOpen, onClose, onConfirm, isDeleting, stateName }: DeleteStateModelProps) {
        ...
        <Modal isOpen={isOpen} onClose={onClose} className="max-w-md">
            <div className="p-6">
                ...
                <p className="mb-6 text-sm text-center text-gray-500">
                    Are you sure you want to delete {stateName ? <strong className="capitalize">{stateName}</strong> : "this state"}?
...
export default DeleteStateModel