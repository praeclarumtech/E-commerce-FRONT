...
interface DeleteCityModelProps {
    isOpen: boolean;
    onClose: () => void;
    onConfirm: () => void;
    isDeleting: boolean;
...
function DeleteCityModel({ isOpen, onClose, onConfirm, isDeleting, cityName }: DeleteCityModelProps) {
        ...
        <Modal isOpen={isOpen} onClose={onClose} className="max-w-md">
            <div className="p-6">
                ...
                <p className="mb-6 text-sm text-center text-gray-500">
                    Are you sure you want to delete {cityName ? <strong className="capitalize">{cityName}</strong> : "this city"}?
...
export default DeleteCityModel