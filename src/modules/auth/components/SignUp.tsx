                                    ...
                                    <div className="space-y-5">
                                        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                            ...
                                            <div className="sm:col-span-1">
                                                ...
                                                />
                                                {formik.errors.fname && formik.touched.fname && <p className="text-error-500">{formik.errors.fname}</p>}
                                            </div>
                                            {/* <!-- Last Name --> */}
                                            <div className="sm:col-span-1">
                                                <Label>
                                                ...
                                                />
                                                {formik.errors.lname && formik.touched.lname && <p className="text-error-500">{formik.errors.lname}</p>}
                                            </div>
                                        </div>
                                        {/* <!-- Email --> */}
                                        <div>
