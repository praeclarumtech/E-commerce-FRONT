...
export default function AsideMenuLayer({ menu, className = "", ...props }: Props) {
  ...
  return (
    <aside
      className={`${className} fixed top-0 z-40 flex h-screen w-60 overflow-hidden transition-(--transition-position) lg:py-2 lg:pl-2`}
    >
      <div
      ...
      >
        ...
        >
          <div className="flex-1 text-center lg:pl-6 lg:text-left xl:pl-0 xl:text-center">
            <b className="font-black">Ecommerce</b>
          </div>
          <button
