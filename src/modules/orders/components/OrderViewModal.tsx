...
function OrderViewModal({ isOpen, onClose, order }: OrderViewModalProps) {
    ...
    const orderId = (order as { orderId?: string }).orderId || order._id;
            ...
            <div className="relative flex flex-col max-h-[90vh]">
                ...
                <div className="overflow-y-auto flex-1 min-h-0">
                    <div className="p-6 border-b border-gray-200 sticky top-0 bg-white z-10">
                        ...
                        {status && (
                            <span className="inline-block mt-2 px-2 py-1 rounded-full text-xs bg-blue-100 text-blue-800 capitalize">
                                {status}
                            </span>
                        )}
                    </div>
