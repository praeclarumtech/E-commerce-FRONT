...
function DeleteUserModal({ isOpen, onClose, onConfirm, isDeleting, userName }: DeleteUserModalProps) {
    return (
        <Modal isOpen={isOpen} onClose={onClose} className="max-w-md">
            <div className="p-6">
                ...
                <p className="mb-6 text-sm text-center text-gray-500">
                    Are you sure you want to delete {userName ? <strong>{userName}</strong> : "this user"}? 
